...
module.exports = {
  async up (queryInterface, Sequelize) {
    try {
      // Console log
      console.log("Altering system_log table - Removing portal_id column");
      ...
      if (tableDefinition && tableDefinition["portal_id"]) {
        await queryInterface.removeColumn("system_log", "portal_id");
      }
    } catch (err) {
      console.log(err);
    }
  ...
  async down (queryInterface, Sequelize) {
    try {
      ...
      if (tableDefinition && !tableDefinition["portal_id"]) {
        await queryInterface.addColumn("system_log", "portal_id", {
