...
module.exports = {
  async up (queryInterface, Sequelize) {
    try {
      // Console log
      console.log("Altering supplier_product_media table - Removing portal_id column");
      ...
      if (tableDefinition && tableDefinition["portal_id"]) {
        await queryInterface.removeColumn("supplier_product_media", "portal_id");
      }
    } catch (err) {
      console.log(err);
    }
  ...
  async down (queryInterface, Sequelize) {
    try {
      ...
      if (tableDefinition && !tableDefinition["portal_id"]) {
        await queryInterface.addColumn("supplier_product_media", "portal_id", {
