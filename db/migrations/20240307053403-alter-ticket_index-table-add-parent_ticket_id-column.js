...
module.exports = {
  async up(queryInterface, Sequelize) {
    try {
      // Console log
      console.log("Altering ticket_index table - Adding parent_ticket_id");
      ...
      if (tableDefinition && !tableDefinition["parent_ticket_id"]) {
        await queryInterface.addColumn("ticket_index", "parent_ticket_id", {
  ...
  async down(queryInterface, Sequelize) {
    try {
      ...
      if (tableDefinition && tableDefinition["parent_ticket_id"]) {
        await queryInterface.removeColumn("ticket_index", "parent_ticket_id");
      }
