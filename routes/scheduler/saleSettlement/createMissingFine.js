...
module.exports = async function (req, res) {
  ...
  let params = { companyId: Request.GetCompanyId(req), id: Request.GetId(req), name:schedularData?.name, systemUser:systemUser,settingArray:settingArray, startDate:schedularData?.start_date,endDate:schedularData?.end_date};
  ...
  res.on("finish", async () => {
    try {
      ...
      await saleSettlementService.createMissingFine(params);
