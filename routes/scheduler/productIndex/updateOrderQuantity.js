...
module.exports = async function (req, res) {
	...
	try {
		...
		res.send(200, { message: "Order Quantity Update Started" });
		...
		res.on("finish", async () => {
			...
			await productService.updateOrderQuantity(companyId, req)

		
            History.create("Product Index: Update Order Quantity Completed", req);
